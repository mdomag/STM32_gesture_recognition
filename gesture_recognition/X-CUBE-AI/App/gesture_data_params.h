...
#define AI_GESTURE_DATA_ACTIVATIONS_SIZES \
  { 16640, }
#define AI_GESTURE_DATA_ACTIVATIONS_SIZE     (16640)
#define AI_GESTURE_DATA_ACTIVATIONS_COUNT    (1)
#define AI_GESTURE_DATA_ACTIVATION_1_SIZE    (16640)



#define AI_GESTURE_DATA_WEIGHTS_SIZES \
  { 255828, }
#define AI_GESTURE_DATA_WEIGHTS_SIZE         (255828)
#define AI_GESTURE_DATA_WEIGHTS_COUNT        (1)
#define AI_GESTURE_DATA_WEIGHT_1_SIZE        (255828)
