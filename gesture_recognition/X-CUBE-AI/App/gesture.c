...
#define AI_GESTURE_MODEL_SIGNATURE     "0xe9e782dcabb8a6955249c4f0744a2a01"
...
#define AI_TOOLS_DATE_TIME   "2025-06-28T18:04:07+0200"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_120_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#14 */
AI_ARRAY_OBJ_DECLARE(
  gemm_9_weights_array, AI_ARRAY_FORMAT_LUT4_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 40, 1), AI_STRIDE_INIT(4, 4, 4, 256, 10240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 20, 1), AI_STRIDE_INIT(4, 4, 4, 512, 10240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  13, 0x0,
  AI_SHAPE_INIT(4, 2560, 64, 1, 1), AI_STRIDE_INIT(4, 1, 1280, 81920, 81920),
...
/* Tensor #20 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_120_output, AI_STATIC,
  20, 0x0,
  AI_SHAPE_INIT(4, 1, 6, 1, 40), AI_STRIDE_INIT(4, 4, 4, 24, 24),
  1, &serving_default_keras_tensor_120_output_array, NULL)

/* Tensor #21 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_120_output0, AI_STATIC,
  21, 0x0,
  AI_SHAPE_INIT(4, 1, 6, 40, 1), AI_STRIDE_INIT(4, 4, 4, 24, 960),
  1, &serving_default_keras_tensor_120_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_120_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_1_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 255828, 1, 1),
    255828, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 16640, 1, 1),
    16640, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_GESTURE_IN_NUM, &serving_default_keras_tensor_120_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_GESTURE_OUT_NUM, &nl_11_output),
  &conv2d_1_layer, 0x9d7c4bca, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_gesture_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_120_output_array.data = AI_PTR(g_gesture_activations_map[0] + 200);
    serving_default_keras_tensor_120_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 200);
    conv2d_1_scratch0_array.data = AI_PTR(g_gesture_activations_map[0] + 1160);
    conv2d_1_scratch0_array.data_start = AI_PTR(g_gesture_activations_map[0] + 1160);
    conv2d_1_output_array.data = AI_PTR(g_gesture_activations_map[0] + 1280);
    conv2d_1_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 1280);
    nl_1_nl_output_array.data = AI_PTR(g_gesture_activations_map[0] + 1280);
    nl_1_nl_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 1280);
    pool_4_output_array.data = AI_PTR(g_gesture_activations_map[0] + 1280);
    pool_4_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 1280);
    conv2d_7_scratch0_array.data = AI_PTR(g_gesture_activations_map[0] + 0);
    conv2d_7_scratch0_array.data_start = AI_PTR(g_gesture_activations_map[0] + 0);
    conv2d_7_output_array.data = AI_PTR(g_gesture_activations_map[0] + 6400);
    conv2d_7_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 6400);
    nl_7_nl_output_array.data = AI_PTR(g_gesture_activations_map[0] + 6400);
    nl_7_nl_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 6400);
    gemm_9_output_array.data = AI_PTR(g_gesture_activations_map[0] + 0);
    gemm_9_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 0);
    nl_9_nl_output_array.data = AI_PTR(g_gesture_activations_map[0] + 256);
    nl_9_nl_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 256);
    gemm_10_output_array.data = AI_PTR(g_gesture_activations_map[0] + 0);
    gemm_10_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 0);
    nl_11_output_array.data = AI_PTR(g_gesture_activations_map[0] + 20);
    nl_11_output_array.data_start = AI_PTR(g_gesture_activations_map[0] + 20);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_gesture_weights_map, 1, params)) {
    ...
    conv2d_1_bias_array.data = AI_PTR(g_gesture_weights_map[0] + 7680);
    conv2d_1_bias_array.data_start = AI_PTR(g_gesture_weights_map[0] + 7680);
    conv2d_7_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_weights_array.data = AI_PTR(g_gesture_weights_map[0] + 7936);
    conv2d_7_weights_array.data_start = AI_PTR(g_gesture_weights_map[0] + 7936);
    conv2d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_bias_array.data = AI_PTR(g_gesture_weights_map[0] + 171776);
    conv2d_7_bias_array.data_start = AI_PTR(g_gesture_weights_map[0] + 171776);
    gemm_9_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_weights_array.data = AI_PTR(g_gesture_weights_map[0] + 172352);
    gemm_9_weights_array.data_start = AI_PTR(g_gesture_weights_map[0] + 172288);
    gemm_9_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_bias_array.data = AI_PTR(g_gesture_weights_map[0] + 254272);
    gemm_9_bias_array.data_start = AI_PTR(g_gesture_weights_map[0] + 254272);
    gemm_10_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_10_weights_array.data = AI_PTR(g_gesture_weights_map[0] + 254528);
    gemm_10_weights_array.data_start = AI_PTR(g_gesture_weights_map[0] + 254528);
    gemm_10_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_10_bias_array.data = AI_PTR(g_gesture_weights_map[0] + 255808);
    gemm_10_bias_array.data_start = AI_PTR(g_gesture_weights_map[0] + 255808);
    return true;
  }
