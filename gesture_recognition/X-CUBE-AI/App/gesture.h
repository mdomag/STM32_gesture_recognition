...
#define AI_GESTURE_ORIGIN_MODEL_NAME   "digits_model_5_types_20250626_215648"
...
#define AI_GESTURE_IN_1_HEIGHT      (40)
#define AI_GESTURE_IN_1_CHANNEL     (6)
#define AI_GESTURE_IN_1_SIZE        (240)
#define AI_GESTURE_IN_1_SIZE_BYTES  (960)
